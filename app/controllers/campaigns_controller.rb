class CampaignsController < ApplicationController
  ...
  def show
    ...
    @chart = LazyHighCharts::HighChart.new('graph') do |f|
        ...
        f.colors(['#663399'])      
        f.series(:type=> 'column',:name=> 'Total Actions',:data=> [@campaign.email_shares ,@campaign.fb_shares ,@campaign.fb_likes ,@campaign.fb_comments ,@campaign.friends_invited ,@campaign.twitter_followers ,@campaign.twitter_shares, @campaign.pins, @campaign.pinterest_followers, @campaign.tumblr_shares ])
    end
